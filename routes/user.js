...
router.get("/new", (req, res) => {
    ...
    http.get('http://localhost:1337/api/employees', (resp) => {
        let data = '';
...
// const users = [{name: "Ranjan"},{name:"Rakesh"}]
...
//     req.params.id
//     req.send(`Update user with id ${req.params.id}`)
// })
// router.delete('/:id', (req, res) => {
//     req.params.id
//     req.send(`Delete user with id ${req.params.id}`)
// })
